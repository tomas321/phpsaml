...
function plugin_phpsaml_install() {
	...
	if (!$DB->tableExists("glpi_plugin_phpsaml_configs")) {
      	$query = "CREATE TABLE `glpi_plugin_phpsaml_configs` (
			...
			`saml_security_destination_insecure` int(2) NOT NULL,
            PRIMARY KEY  (`id`)
